...
Сервер обеспечивает возможность выполнения DNS-запросов клиентами, сохраняет записи DNS в кэше и проверяет наличие интернет-соединения перед выполнением новых запросов к авторитетному DNS-серверу.
